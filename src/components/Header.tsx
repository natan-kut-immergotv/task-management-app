          ...
          <div className="relative">
            ...
            {showUserMenu && (
              <motion.div
                ...
                className="absolute right-0 top-12 z-50 w-48 rounded-lg border bg-white py-1 shadow-lg"
              >
                ...
                <button className="flex w-full items-center gap-2 px-3 py-2 text-sm text-neutral-700 hover:bg-neutral-100">
